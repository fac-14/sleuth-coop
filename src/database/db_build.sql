...
('Service(s) this product could be relevant to', 'dropdown', 'What service(s) could the product be relevant to? For example: parking, council tax, vulnerable adults.', 'Product', ARRAY['Adult Education', 'Adults Social care', 'Archaeology', 'Arts', 'Building Control', 'Business Services', 'Carers Services', 'Cemeteries', 'Children''s Social Care', 'Coastal Protection', 'Council Housing Management' ,'Council Tax', 'Council wide', 'Disabled Adults', 'Early Years', 'Education Provision', 'Education Welfare', 'Electoral Services', 'Environmental Services', 'Family Support', 'Farming', 'Further Education', 'Health and Safety', 'Highways', 'Housing Advice', 'Housing Benefits', 'Housing Needs', 'Land Registry', 'Leaseholder Services', 'Leisure', 'Libraries', 'Looked after Children', 'Parking', 'Planning', 'Public Health', 'Recycling', 'Registrars', 'Regulatory Services', 'School Admissions', 'Signposting', 'Special Educational Needs', 'Sundry Debtors', 'Transport', 'Waste collection', 'Welfare benefits']),
...
('Type of council(s) running this product', 'dropdown', 'What type of council(s) is it running with?', 'Local Authorities', ARRAY['City of London', 'County Councils', 'District Councils', 'London Boroughs', 'Metropolitan Districts', 'Town And Parish Councils', 'Unitary Authorities', 'Other']),
('Areas of local authority services the product could be relevant to', 'dropdown', 'What other types of local authority services would your product be relevant to?', 'Local Authorities', ARRAY['Accomodation', 	'Administration, Co-ordination, Consultation, Events', 	'Care, Support and Counselling', 	'Claims and Compliants', 	'Control, compliance and regulation', 	'Corporate', 	'Corporate Parent', 	'Crime prevention', 	'Eligibility, Grants, Benefits and Fraud', 	'Emergency Support', 	'Environmental Cleanliness, Blights and Hazards', 	'Fair allocation of limited resources', 	'Health and Safety', 	'Information, Advice and Advocacy', 	'Landlord',  'Local Tax', 	'Personal Development and Jobs', 	'Planning, Strategy, Research, Consultancy, Sustainability and Infrastructure', 	'Registers and Public Record Keeping',	'Revenue', 'Transport', 'Wellbeing']),
