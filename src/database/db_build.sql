...
('What type of council(s) is it running with?', 'dropdown', '', 'Local Authorities', ARRAY['Unitary Authorities', 'London Boroughs', 'Metropolitan Districts', 'County Councils', 'District Councils', 'City of London', 'Town And Parish Councils', 'Other']),
...
(1, 3, ARRAY['yes']),
(1, 5, ARRAY['Staff Team', 'Further Education', 'Looked after Children']),
